...
SWIFT_CLASS("_TtC11FindMyPeeps11AppDelegate")
...
SWIFT_CLASS("_TtC11FindMyPeeps14ViewController")
@interface ViewController : UIViewController <CLLocationManagerDelegate>
@property (nonatomic, weak) IBOutlet UIButton * __null_unspecified updateButton;
...
- (IBAction)button_clicked:(id __nonnull)sender;
- (void)locationManager:(CLLocationManager * __nonnull)manager didUpdateLocations:(NSArray * __nonnull)locations;
- (IBAction)testSendPostButton:(id __nonnull)sender;
- (void)initLocationManager:(CLLocationManager * __nonnull)locationManager;
